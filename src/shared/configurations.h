...
// Post-filter stage gate. Compile-time gate is separate from the runtime
// post_filter_enabled parameter, which defaults to false so the stage stays
// out of the tuning path unless explicitly armed on the device.
#define POSTFILTER_ENABLED 1

// Tone-Kill filter — continuous-tone suppressor (600-800 Hz tuning leaks)
#define TONE_KILL_MIN_HZ 600.F
#define TONE_KILL_MAX_HZ 800.F
#define TONE_KILL_DOMINANCE_DB 10.F    // peak vs band median
#define TONE_KILL_CONTINUITY_MS 1200U  // > 5 WPM dah (720 ms)
#define TONE_KILL_RELEASE_MS 200U      // < 5 WPM element gap (240 ms)
#define TONE_KILL_MIN_POWER 1e-7F      // absolute floor; calibrate on bench
#define TONE_KILL_NULL_WIDTH_BINS 1    // ±1 bin around the peak
...
// Fft configuration
#define PADDING_CONFIGURATION_GENERAL NEXT_POWER_OF_TWO
...
// Fft configurations
#define PADDING_CONFIGURATION_SPEECH NEXT_POWER_OF_TWO
